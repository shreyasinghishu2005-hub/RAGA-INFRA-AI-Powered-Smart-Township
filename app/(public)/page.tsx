...
const zones = [
  {
    icon: Building2,
    title: "Residential",
    desc: "Smart apartments & premium villas with AI automation",
  ...
  },
  {
    ...
    desc: "30-acre tech hub with co-working and innovation centers",
  ...
  },
  {
    icon: GraduationCap,
    title: "Education Hub",
    desc: "2 colleges + 2 schools with AI-powered learning",
  ...
  },
  {
    icon: Hospital,
    title: "Healthcare",
    desc: "3 smart hospitals with AI diagnosis and ambulance tracking",
  ...
  },
  {
    icon: Sun,
    title: "Solar Farm",
    desc: "2.4 MW solar production with battery storage and grid export",
  ...
  },
  {
    icon: Leaf,
    title: "Eco & Parks",
    desc: "Central park, rainwater lake, green belts and smart irrigation",
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          >
            AI-powered living with solar energy, smart security, elder care, and
            IoT-connected infrastructure — all in one integrated 300-acre township.
          </motion.p>
          ...
          >
            <Link
              ...
              className="px-8 py-4 bg-gradient-to-r from-brand-blue to-brand-cyan text-white rounded-xl font-semibold hover:opacity-90 transition-opacity glow-blue"
            >
              Book a Property
            </Link>
            <Link
              href="/map"
              className="px-8 py-4 glass border border-white/20 text-white rounded-xl font-semibold hover:border-brand-cyan/40 transition-colors"
            >
              Explore Live Map
            </Link>
          </motion.div>
      ...
      <section className="py-12 px-4 border-y border-white/10">
        <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-brand-cyan to-brand-green bg-clip-text text-transparent">
                {stat.value}
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              Every acre designed with purpose — from smart residences to eco-friendly infrastructure
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {zones.map((zone, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${zone.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {features.map((f, i) => (
              <motion.div
                ...
                className="glass p-4 flex flex-col items-center text-center gap-3"
              >
      ...
      <section className="py-24 px-4 text-center">
        ...
        >
          ...
          <p className="text-slate-400 mb-8">
            Book your property in Raga Infra Smart Township today and be part of the future.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/booking/residential"
              className="px-8 py-4 bg-brand-blue hover:bg-brand-blue/80 text-white rounded-xl font-semibold transition-colors"
            >
              Residential Booking
            </Link>
            <Link
              href="/booking/commercial"
              className="px-8 py-4 glass border border-white/20 text-white rounded-xl font-semibold hover:border-brand-cyan/40 transition-colors"
            >
              Commercial Booking
            </Link>
            <Link
              href="/chatbot"
              className="px-8 py-4 glass border border-brand-green/30 text-brand-green rounded-xl font-semibold hover:bg-brand-green/10 transition-colors"
            >
              Ask AI Chatbot
            </Link>
          </div>
