...
export default function MasterPlanContent() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="glass p-8 mb-10">
        ...
        <div className="space-y-3">
          {zones.map((z, i) => (
            <motion.div key={z.label} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.03 }} className="flex items-center gap-4">
